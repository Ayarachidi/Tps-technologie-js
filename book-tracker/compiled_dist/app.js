...
mongoose_1.default.connect('mongodb://localhost:27017/booktracker').then(() => console.log("Connecté à MongoDB")).catch(error => console.error("Erreur de connexion à MongoDB:", error));
...
app.put('/books/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
  const updatedBook = yield BookModel.findByIdAndUpdate(req.params.id, req.body, {
    new: true
  });
